...
def basic_stoye_gusfield_loopy(node: Node, depthfirst_to_suffix, sequence, testing):
...
def stoye_gusfield_loopy(node: Node, depthfirst_to_suffix, sequence, testing):
    # init stack
    stack = deque()
    stack.append(node)
    visited = set()
